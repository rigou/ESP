...
/*  Load the whole file in RAM and close it
...
// Save the contents of mCells[] to a file and close it
// return value: number of lines written, negative value on error  (do not modify these negative values)
// lines_int optional, number of lines to save after creating a file (Load() was not called in this case, and mLines_int=0)
// path_str optional, path to the file to save, if different from mPath_str
int rgCsv::Save(int lines_int, const char *path_str) {
	int retval_int=0;
	int line_int=0;
